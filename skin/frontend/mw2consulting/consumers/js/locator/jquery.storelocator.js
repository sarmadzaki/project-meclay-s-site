...
(function($){
$.fn.storeLocator = function(options,callback) {
  ...
  var settings = $.extend( {
      ...
      'distanceAlert': 60,
      'dataType': 'json',
      'dataLocation': window.location.protocol + "//" + window.location.host + '/practitioners/index/json',	 
      'listColor1': 'ffffff',
      'listColor2': 'eeeeee',
      'originMarker': false,
      'originpinColor': 'blue',
      ...
      'infowindowTemplatePath': window.location.protocol + "//" + window.location.host + '/skin/frontend/mw2consulting/consumers/js/locator/html/infowindow-description.html',
      'listTemplatePath': window.location.protocol + "//" + window.location.host + '/skin/frontend/mw2consulting/consumers/js/locator/html/location-list-description.html',
      'KMLinfowindowTemplatePath': window.location.protocol + "//" + window.location.host + '/skin/frontend/mw2consulting/consumers/js/locator/html/kml-infowindow-description.html',
      'KMLlistTemplatePath': window.location.protocol + "//" + window.location.host + '/skin/frontend/mw2consulting/consumers/js/locator/html/kml-location-list-description.html',
      ...
      'distanceErrorAlert': 'Please call us at 844.PCA.CHAT [722.2428] or e-mail us at customer_care@pcaskin.com and we’ll help you locate a PCA Certified Professional.',
      'mileLang': 'mile',
      'milesLang': 'miles',
  ...
  function begin_mapping(distance){
    ...
    if($('#postcode').length){
		if($('#postcode').val() != ""){
		  $('#' + settings.inputID).val($('#postcode').val()); 
		  $('#postcode').val('');
		}
	}
  ...
  $(function(){
    ...
    //     begin_mapping();
      ...
      // $(document).on('keyup', '#locator-form', function(e){
      //   if(e.keyCode == 13)
      //     get_form_values(e);
      // });
      $(document).on('click.'+prefix, '#' + settings.formContainerDiv + ' #locator-search-button', function(e){
        entered = true;
        get_form_values(e);
      });

      $(document).on('submit.'+prefix, '#product_addtocart_form', function(e){
        entered = true;
        get_form_values(e);
      });
    }
  ...
  $(function(){
        ...
        success: function (data, xhr, options){
            ...
            if(settings.dataType === 'json' || settings.dataType === 'jsonp'){
              ...
              //Process XML
              // var arrayFromPHP = <?php echo json_encode(Mage::helper('mw2_locator')->getStoreAddresses()); ?>;
          ...
          $(function(){ 
             ...
             var key, value, locationData = {};
              ...
              myOptions.styles = [{"featureType":"landscape.man_made","elementType":"geometry","stylers":[{"color":"#f7f1df"}]},{"featureType":"landscape.natural","elementType":"geometry","stylers":[{"color":"#d0e3b4"}]},{"featureType":"landscape.natural.terrain","elementType":"geometry","stylers":[{"visibility":"off"}]},{"featureType":"poi","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"poi.business","elementType":"all","stylers":[{"visibility":"off"}]},{"featureType":"poi.medical","elementType":"geometry","stylers":[{"color":"#fbd3da"}]},{"featureType":"poi.park","elementType":"geometry","stylers":[{"color":"#bde6ab"}]},{"featureType":"road","elementType":"geometry.stroke","stylers":[{"visibility":"on"}]},{"featureType":"road","elementType":"labels","stylers":[{"visibility":"on"}]},{"featureType":"road.highway","elementType":"geometry.fill","stylers":[{"color":"#ffe15f"}]},{"featureType":"road.highway","elementType":"geometry.stroke","stylers":[{"color":"#efd151"}]},{"featureType":"road.arterial","elementType":"geometry.fill","stylers":[{"color":"#ffffff"}]},{"featureType":"road.local","elementType":"geometry.fill","stylers":[{"color":"black"}]},{"featureType":"transit.station.airport","elementType":"geometry.fill","stylers":[{"color":"#cfb2db"}]},{"featureType":"water","elementType":"geometry","stylers":[{"color":"#a2daf2"}]}]
              
              var selectedIcon = window.location.protocol + "//" + window.location.host + "/skin/frontend/mw2consulting/consumers/images/consumers/map/map-icon-active.png";
              var oldIcon = 'http://maps.google.com/mapfiles/ms/icons/'+ settings.originpinColor +'-dot.png';
              ...
              function createMarker(point, name, address, letter){
                ...
                var standardPin = window.location.protocol + "//" + window.location.host + "/skin/frontend/mw2consulting/consumers/images/consumers/map/map-icon.png";
                var oldPin = "http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=" + letter + "|" + settings.pinColor + "|" + settings.pinTextColor;
                var pinImage = new google.maps.MarkerImage(standardPin,
              ...
              function create_infowindow(marker, location){
                ...
                //Define the location data
                var locations = define_location_data(marker);
                if(locations.location[0]['show_popup'] == 1){
                ...
                google.maps.event.addListener(infowindow, 'domready', function() {
                   ...
                   iwCloseBtn.html('<button class="circle--close" style="border-color:white;"><i class="icon icon-close" style="color:white;"></i></button>');
                   iwCloseBtn.css({
                      width: '57px',
                      height: '60px',
                      top: '50px',
                ...
                //Opens the infowindow when the marker is clicked
                  ...
                  google.maps.event.addListener(marker, 'click', function() {
                      ...
                      if(locations.location[0]['show_popup'] == 1 && typeof formattedAddress != typeof undefined){
                        infowindow.setContent(formattedAddress);
                        infowindow.open(marker.get('map'), marker);
                      }else{
                        infowindow.close();
          ...
          if($('#postcode').val() != '' && typeof($('#postcode').val()) != 'undefined')
          {
            begin_mapping();
          }
          //choose first item of the list after search
          $('#loc-list li[data-markerid=0]').trigger("click"); 
